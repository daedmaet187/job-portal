...
$email_message = '<html lang="ar" dir="rtl">';
...
<div id="wrapper"> 
  ...
  <header id="header"> 
    ...
    <div class="cp-burger-nav"> 
      ...
      <div id="cp_side-menu-btn" class="cp_side-menu"><a href="#" class=""><img src="../files/images/menu-icon.png" alt="img"></a></div>
      ...
      <div id="cp_side-menu"> <a href="#" id="cp-close-btn" class="crose"><i class="fa fa-close"></i></a>
        ...
        <strong class="logo-2"><a href="index.html"><img src="../files/images/sidebar-logo.png" alt="img"></a></strong>
      ...
      <div class="navigation-col">
        ...
        <nav class="navbar navbar-inverse">
          ...
          <div class="navbar-header">
            ...
            <strong class="logo"><a href="index.html"><img src="../files/images/logo.png" alt="logo"></a></strong> </div>
    ...
    <div class="user-option-col">
      ...
      <div class="thumb">
        ...
        <div class="dropdown">
          ...
          <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <img src="../files/images/user-img.png" alt="img"></button>
      ...
      <div class="dropdown-box">
        ...
        <div class="dropdown">
          ...
          <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <img src="../files/images/option-icon.png" alt="img"> </button>
