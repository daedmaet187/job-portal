          ...
          <div class="col-md-12 col-sm-8">
            ...
            <div class="resumes-content">
              ...
              <div class="box">
                ...
                <div class="frame"><a href="#"><img src="../files/images/resumes/resumes-img-1.jpg" alt="img"></a></div>
...
foreach($results as $result)
{
 ?>
     <div class="text-box">
                  ...
                  <div class="btn-row"> <a href="../files/Jobseekersresumes/<?php echo htmlentities($result->Resume);?>" class="resume" target="_blank"><i class="fa fa-file-text-o"></i>السيرة الذاتية</a> <a href="#" class="login">تعديل الصفحة</a> </div>
