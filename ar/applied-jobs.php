...
<title>بوابة الوظائف - تاريخ الوظائف المقدم عليها</title>
...
<div id="wrapper"> 
  ...
  <section id="inner-banner">
    ...
    <div class="container">
      ...
      <h1>تاريخ الوظائف المقدم عليها</h1>
    </div>
  ...
  <hr />
              <div class="box"  style="padding-top: 20px">
                ...
                <div class="text-col">
                  ...
                  <p><?php  echo htmlentities($row->CompnayName);?> <em><a href="index.php">عرض جميع الوظائف</a></em></p>
...
else
{
  echo $pstatus=$row->Status;
     ...
     <div class="btn-row"> <a href="../files/Jobseekersresumes/<?php echo htmlentities($row->Resume);?>" class="resume"><i class="fa fa-file-text-o"></i>السيرة الذاتية</a> <a href="app-details.php?jobid=<?php echo ($row->JobId);?>" class="contact">عرض التفاصيل</a></div>
