...
{               ?>
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell">$<?php  echo htmlentities($row->PostingDate);?></td>
                                         ...
                                         <td class="d-none d-sm-table-cell"><a href="manage-category.php?delid=<?php echo htmlentities ($row->id);?>" onclick="return confirm('Do you really want to Delete ?');"><i class="fa fa-trash fa-delete" aria-hidden="true"></i></a> || <a href="edit-category.php?editid=<?php echo htmlentities ($row->id);?>"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                    </tr>
                                    <?php $cnt=$cnt+1;}} ?> 
