...
$img=md5($img).time().$extension;
 move_uploaded_file($_FILES["image"]["tmp_name"],"../files/images/".$img);
...
<img src="../files/images/<?php echo $result->ProfilePic;?>" width="100" height="100" value="<?php  echo $result->ProfilePic;?>"><br />
</div>
