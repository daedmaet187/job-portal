...
<?php  }} ?>
              ...
              <h2 style="color: red">Job search against <?php  echo htmlentities($_GET['jobtitle']);?></h2> 
...
<a <?php if($page_no < $total_no_of_pages) { echo "href='$params&page_no=$next_page'"; } ?>>Next</a>
</li>
