              ...
              <div style="margin-bottom: 30px;">
                <form method="post">
                  ...
                  <div class="mb-3" style="margin-top: 10px;">
                    <label for="exampleFormControlTextarea1" class="form-label">المحتوى</label>
                  ...
                  <div style="margin-top: 10px;">
                    <input type="submit" value="نشر" name="submit" class="btn btn-primary" />
                  </div>
                </form>
              </div>
              <?php } ?>

              <h2 style="color: red">تدوينات</h2> 
