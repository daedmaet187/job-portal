...
<option value="">اختار المؤهلات</option>
  <option value="10th std">متوسطة</option>
  <option value="12th std">اعدادية</option>
  <option value="Graduation">بكالوريوس</option>
  <option value="Post Graduation">ماجستير</option>
  <option value="Others">اخرى</option>
</select>
</div>

<div class="col-md-6 col-sm-6">
<label>اسم المدرسة او الجامعة *</label>
