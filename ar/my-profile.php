...
<title>الباحثين عن عمل | الصفحة</title>
 ...
 <?php include('includes/header.php');?>
  ...
  <section id="inner-banner">
    ...
    <div class="container">
      ...
      <h1>صفحة <?php echo htmlentities($_SESSION['jsfname']);?></h1>
...
foreach($results as $result)
{
 ?><a href="#"><img src="../files/images/<?php echo $result->ProfilePic;?>" width="100" height="100" alt="img"></a></div>
     ...
     <div class="text-box">
                  ...
                  <div class="btn-row"> <a href="../files/Jobseekersresumes/<?php echo htmlentities($result->Resume);?>" class="resume" target="_blank"><i class="fa fa-file-text-o"></i>السيرة الذاتية</a> <a href="profile.php" class="login">تعديل الحساب</a> <a href="add-education.php" class="login">اضافة تعليم</a><a href="add-experience.php" class="login">اضافة خبرة</a></div>
 ...
 ?>
                <div class="outer"> <strong class="title"><?php echo htmlentities($result->Qualification);?></strong>
                  ...
                  <div class="col"> <span><?php echo htmlentities($result->PassingYear);?></span>
                    ...
                    <p><strong style="color: blue">اسم الكلية او المدرسة</strong>: <?php echo htmlentities($result->ClgorschName);?></p>
                    <!--<p><strong style="color: blue">Stream</strong>: <?php echo htmlentities($result->Stream);?></p>-->
                    <p><strong style="color: blue">الدرجة</strong>: <?php echo htmlentities($result->CGPA);?></p>
