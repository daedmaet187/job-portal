...
echo "<script>alert('بريد الكتروني او كلمة مرور غير صحيحة');</script>";
...
<head>
<title>الشركات | تسجيل دخول</title>
    ...
    <section class="signup-section">
      ...
      <div class="container">
        ...
        <div class="holder">
          ...
          <div class="thumb"><img src="../../files/images/account.png" alt="img"></div>

          <form method="post" name="emplsignin">

            <div class="input-box"> <i class="fa fa-user"></i>

<input type="text" placeholder="البريد الالكتروني" name="email"  autocomplete="off" required>
...
<div class="input-box"> 
       <input type="submit" value="تسجيل دخول" name="signin">

</div>

            <a href="forgot-password.php" class="login">نسيت كلمة المرور</a> <b>او</b>

            <div class="login-social">
              <em>ليس لديك حساب؟ <a href="employers-signup.php">تسجيل حساب جديد</a></em> </div>

          </form>
<a href="../index.php"><i class="fa fa-home" aria-hidden="true" style="font-size: 30px;padding-top: 10px"></i>  العودة الى الرئيسية</a>
        </div>
