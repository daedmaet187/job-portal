...
echo "<script>alert('بريد الكتروني، رقم هاتف او كلمة مرور غير صحيحة');</script>";
...
<input type="text" placeholder="البريد الالكتروني او رقم الهاتف" name="emailmbile"  autocomplete="off" required>
...
<div class="input-box"> 
       <input type="submit" value="تسجيل دخول" name="signin">
            ...
            <div class="login-social">
              <em>ليس لديك حساب؟ <a href="sign-up.php">تسجيل حساب جديد</a></em> </div>
