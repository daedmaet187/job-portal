...
<div class="hold" style="width:100%">
 ...
 <!-- Job Title -->  
<h4><a href="job-details.php?jobid=<?php echo htmlentities($result->jobId);?>" title='View Details'><?php echo htmlentities($result->jobTitle);?></a> --------- <em><a href="edit-job.php?jobid=<?php echo htmlentities($result->jobId);?>" title='Edit Job Details'>(Edit this job)</a></em> | <a href="job-listing.php?delid=<?php echo ($result->jobId);?>" onclick="return confirm('Do you really want to Delete ?');" style="color:red;">Delete</i>
