...
?> 
                            <a class="block text-center" href="listed-jobs.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-sea">
                        ...
                        <div class="col-6 col-md-4 col-xl-3">
                             <?php 
$sql4 ="SELECT blog_id from blogs";
$query4 = $dbh -> prepare($sql4);
$query4->execute();
$results=$query4->fetchAll(PDO::FETCH_OBJ);
$totaljobs=$query4->rowCount();
?> 
                            <a class="block text-center" href="blogs.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-sea">
                                    ...
                                    <p class="font-w600 text-white">Total Blogs</p>
                                </div>
                            </a>
                        </div>
