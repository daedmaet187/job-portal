...
foreach($results as $result)
{
 ?>
        ...
        <a href="#">
          <img src="../../files/employers/employerslogo/<?php echo htmlentities($result->CompnayLogo);?>" alt="img" width="165" height="165"></a></div>
                <div class="text-col">
...
<a class="text"><i class="fa fa-map-marker"></i><?php echo $locsArray[$result->jobLocation];?></a> 
...
<a href="candidatelist-pjob.php?jobid=<?php echo $result->jobId;?>" class="btn-style-1 style-big">List of Canditates apllied for this job</a> </div>
