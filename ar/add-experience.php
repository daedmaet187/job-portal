...
<input type="text" name="toe" required="true" placeholder="جزئي، دوام كامل" autocomplete="off" value="" class="form-control">
</div>
          
<div class="col-md-6 col-sm-6">
<label>المسمى الوظيفي</label>
<input type="text" name="designation" placeholder="" autocomplete="off" value="" required="true" class="form-control">
<label>الراتب الشهري</label>
<input type="text" name="ctc" autocomplete="off" placeholder="500000 - 750000" value="" class="form-control" pattern="[0-9]+">
</div>
