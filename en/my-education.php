...
foreach($results as $result)
{
 ?>
     <div class="text-box">
                  ...
                  <div class="btn-row"> <a href="../files/Jobseekersresumes/<?php echo htmlentities($result->Resume);?>" class="resume" target="_blank"><i class="fa fa-file-text-o"></i>Resume</a> <a href="#" class="login">Edit Profile</a> </div>
