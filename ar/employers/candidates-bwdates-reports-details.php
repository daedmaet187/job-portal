...
?>
<h2 align="center" style="color:blue">التقرير من <?php echo $fdate?> الى <?php echo $tdate?></h2>
<?php
...
{               ?>
                <div class="frame"><a href="#"><img src="../../files/images/<?php echo $row->ProfilePic;?>" width="100" height="100"></a></div>
                ...
                <div class="text-box">
                  ...
                  <h4>تاريخ التقديم: <?php echo htmlentities($row->Applydate);?></h4>
<h4><a href="#">الوظيفة المقدم لها: <?php echo htmlentities($row->jobTitle);?>(<?php echo htmlentities($row->jobType);?>)</a></h4>
...
else
{
  echo $pstatus=$row->Status;
     ...
     ;?></a>  </div>
                  ...
                  <div class="btn-row"> <a href="../../files/Jobseekersresumes/<?php echo htmlentities($row->Resume);?>" class="resume"><i class="fa fa-file-text-o"></i>السيرة الذاتية</a> <a href="candidates-details.php?canid=<?php echo ($row->id);?>" class="contact">عرض التفاصيل</a> <a href="app-details.php?jobid=<?php echo ($row->JobId);?> && name=<?php echo htmlentities ($row->FullName);?>" class="login">تفاصيل الطلب</a></div>
...
<h4 align="center" style="color:blue">لا توجد عناصر للعرض</h4>
