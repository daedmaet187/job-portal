...
<label>Resume</label>
<img src="../files/images/pdf.png" title="Click Here for View Resume"><a href="../files/Jobseekersresumes/<?php echo $result->Resume;?>" target="_blank">Click Here for View Resume</a>
