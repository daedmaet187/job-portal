...
foreach($results as $result)
{
 ?><a href="#"><img src="../files/images/<?php echo $result->ProfilePic;?>" width="100" height="100" alt="img"></a></div>
     ...
     <div class="text-box">
                  ...
                  <div class="btn-row"> <a href="../files/Jobseekersresumes/<?php echo htmlentities($result->Resume);?>" class="resume" target="_blank"><i class="fa fa-file-text-o"></i>Resume</a> <a href="profile.php" class="login">Edit Profile</a> <a href="add-education.php" class="login">Add Education</a><a href="add-experience.php" class="login">Add Experience</a></div>
