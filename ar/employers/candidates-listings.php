...
<title>الشركات | قائمة المقدمين</title>
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-sm-8">
            ...
            <div class="resumes-content">
              <h2>عرض السير الذاتية من قبل المرشحين المتقدمين</h2>
...
$eid=$_SESSION['emplogin'];
  ...
  $next_page = $page_no + 1;
  $adjacents = "2"; 
$ret = "SELECT jobId FROM tbljobs where tbljobs.employerId=:eid";
