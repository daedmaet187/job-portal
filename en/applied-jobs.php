...
else
{
  echo $pstatus=$row->Status;
     ...
     <div class="btn-row"> <a href="../files/Jobseekersresumes/<?php echo htmlentities($row->Resume);?>" class="resume"><i class="fa fa-file-text-o"></i>Resume</a> <a href="app-details.php?jobid=<?php echo ($row->JobId);?>" class="contact">View Detail</a></div>
