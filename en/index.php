...
<?php include_once('includes/header.php');?>
  ...
  <select class="full-width" name="joblocation" style="width: 100%">
    ...
    <option value="2">al-Anbar</option>
    <option value="3">Babil</option>
    <option value="4">Basrah</option>
    <option value="5">Duhuk</option>
    <option value="6">Dhi Qar</option>
    <option value="7">Diyala</option>
    <option value="8">Erbil</option>
    <option value="9">Karbala</option>
    <option value="10">Kirkuk</option>
    <option value="11">Maisan</option>
    <option value="12">al-Muthanna</option>
    <option value="13">Najaf</option>
    <option value="14">Ninawa</option>
    <option value="15">al-Qadisiya</option>
    <option value="16">Salah ad-Din</option>
    <option value="17">as-Sulaimaniya</option>
    <option value="18">Wasit</option>
  </select>
...
<?php if (strlen($_SESSION['jsid']==0)) {?>
        <div class="btn-row"> <a href="sign-up.php"><i class="fa fa-user"></i>I’m a Jobseeker</a> <a href="../en/employers/employers-signup.php"><i class="fa fa-building-o"></i>I’m an Employer</a> </div>
<?php } ?>
      </div>
    ...
    <section class="popular-categories">
      ...
      <div class="container">
        ...
        <div class="clearfix">
          ...
          <a href="job-search.php" class="btn-style-1">Explore All Jobs</a> </div>
...
{               ?>
          <div class="col-md-3 col-sm-6">
            ...
            <div class="box"> <img src="../en/images/jobs.jpg" alt="img" width="68" height="68">
